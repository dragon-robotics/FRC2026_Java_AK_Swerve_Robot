...
//
// Ported from dragon-robotics/FRC2026_Java_Swerve_Robot (feature/shift-timers).
...
/**
 * Tracks the current "shift" of a FRC match (auto, shift 1-4, endgame) based on match time, and
 * exposes helpers for determining when this alliance's shift is active, including fudge factors for
 * time-of-flight and fuel-count delay around shift boundaries.
 */

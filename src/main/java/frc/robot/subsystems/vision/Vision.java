  ...
  public void periodic() {
    ...
    for (int cameraIndex = 0; cameraIndex < io.length; cameraIndex++) {
      ...
      for (var observation : inputs[cameraIndex].poseObservations) {
        ...
        boolean rejectPose =
            observation.tagCount() == 0 // Must have at least one tag
                || (observation.tagCount() == 1
                    && observation.ambiguity() > VisionConstants.SINGLE_TAG_MAX_AMBIGUITY) // Cannot be high ambiguity
        ...
        double linearStdDev = VisionConstants.LINEAR_STDDEV_BASELINE * stdDevFactor;
        double angularStdDev = VisionConstants.ANGULAR_STDDEV_BASELINE * stdDevFactor;
        if (observation.type() == PoseObservationType.MEGATAG_2) {
          linearStdDev *= VisionConstants.LINEAR_STDDEV_MEGATAG2_FACTOR;
          angularStdDev *= VisionConstants.ANGULAR_STDDEV_MEGATAG2_ANGLE_FACTOR;
        }
